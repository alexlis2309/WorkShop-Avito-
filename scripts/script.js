const modalAdd = document.querySelector(".modal__add"),
    ...
    closeBtnAdd = modalAdd.querySelector(".modal__close"),
    submitBtnAdd = modalAdd.querySelector(".modal__btn-submit"),
    formAdd = modalAdd.querySelector(".modal__submit");

const catalog = document.querySelector(".catalog"),
 modalItem = document.querySelector(".modal__item"),
 closeBtnItem = modalItem.querySelector(".modal__close");
